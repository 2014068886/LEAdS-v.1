...
if (levelalarm==0){document.location="index.php";}
if (levelalarm==2){document.location="index2.php";}
...
if (sen23>=0)
{ident1a=3;}
var data99=rainsense;
var data98=moissense;

if ((data98==2)&&(data99==2)){  document.location="index2.php";}
if ((data98==3)&&(data99==2)){  document.location="index2.php";}
if ((data98==2)&&(data99==3)){  document.location="index2.php";}
if ((data98==2)&&(data99==3)){  document.location="index2.php";}

if ((data98==3)&&(data99==3)){  document.location="index3.php";}


if ((sen21>0)&&(sen22<0)&&(sen23<0)){data99=1; document.location="level1m.php";}
if ((sen21>0)&&(sen22>0)&&(sen23<0)){data99=2; document.location="level2m.php";}
if ((sen21>0)&&(sen22>0)&&(sen23>0)){data99=3; document.location="level3m.php";}
if ((sen11>0)&&(sen12<0)&&(sen13<0)){data98=1; document.location="level1r.php";}
if ((sen11>0)&&(sen12>0)&&(sen13<0)){data98=2; document.location="level2r.php";}
if ((sen11>0)&&(sen12>0)&&(sen13>0)){data98=3; document.location="level3r.php";}
